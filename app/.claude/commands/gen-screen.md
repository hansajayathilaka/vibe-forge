...
Create `screens/<name>.json` where `<name>` is a kebab-case identifier for the screen.
...
Append the following entry to `screens/_index.json`:
...
- State the filename: `behaviours/<name>.js`
